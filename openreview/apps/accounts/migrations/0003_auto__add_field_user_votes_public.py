...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.votes_public'
        db.add_column('accounts_user', 'votes_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.votes_public'
        db.delete_column('accounts_user', 'votes_public')
    ...
    models = {
        'accounts.user': {
            ...
            'votes_public': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'auth.group': {
